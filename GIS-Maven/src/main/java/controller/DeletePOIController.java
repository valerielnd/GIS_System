...
/**
 * FXML Controller class for the delete POI page
 ...
 * @version 3.0
 */
public class DeletePOIController  implements Initializable{
    ...
    */
    ...
    /**
     * Cancel the action of deleting the POI
    ...
    void delete(ActionEvent event) {
        ...
        deleteAlert.setContentText("This will permantly delete the custom POI");
